...
export default function Navbar() {
  ...
  const mobileSolutionzLogo = images["mobile-solutionz-logo.webp"];
  ...
  return (
    <header
      className={`fixed w-full z-[1000] transition-all duration-300 ${isScrolled || mobileMenuOpen ? "bg-black" : "bg-transparent"}`}
    >
      {/* Desktop Navigation */}
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8">
        ...
        <div className="hidden lg:flex lg:gap-x-12">
          <Link
            href="#services"
            className="text-lg font-semibold text-white hover:text-[#606c38] transition-colors duration-200"
          >
            Services
          </Link>
          <Link
            ...
            <div className="relative w-full max-w-md transform">
              ...
              <div className="mt-32 space-y-6">
                <Link
                  href="#services"
                  onClick={() => setMobileMenuOpen(false)}
                  className="block w-full py-3 text-white hover:text-[#606c38] transition-colors duration-200"
                >
                  Services
                </Link>
                <Link
                ...
                <Link
                  href="#contact"
                  className="block w-full bg-[#606c38] px-6 py-3 rounded-full text-white hover:bg-[#515c30] transition-all duration-300"
                >
                  Book Now
                </Link>
              </div>
