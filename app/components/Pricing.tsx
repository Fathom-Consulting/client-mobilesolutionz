...
const services = [
  ...
  },
  {
    name: "CeramicPro",
    price: "$800 - $1400",
    description: "The ultimate in car care and future protection.",
    features: {
      interior: [
        "Ceramic leather coating",
        "Full spot extraction",
  ...
  },
  {
    ...
    price: "Varies",
    description:
      "Build your own custom package tailored to your vehicle's needs",
    features: {
...
const addOns = [
  {
    ...
    description:
      "Our O-Zone Treatment is a powerful, eco-friendly method to eliminate stubborn odors and sanitize your vehicle's interior, leaving it fresh and clean.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Our Glass Polish and Coating service enhances visibility and protects your vehicle's windows, making them easier to clean and more resistant to environmental contaminants.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Our Paint Correction service restores your vehicle's paint to its original glory, removing swirl marks, light scratches, and oxidation for a flawless finish.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Our Spot Extraction service targets stubborn stains and spots in your vehicle's interior, restoring the clean look of your carpets and upholstery.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Our Engine Bay Clean-up service degreases and details your vehicle's engine compartment, improving its appearance and making it easier to spot potential issues.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Our Interior Ceramic Leather Coating service provides long-lasting protection for your vehicle's leather surfaces, keeping them looking new and easy to clean.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Our Wheel Polish and Coating service restores the shine to your wheels and protects them from brake dust, road grime, and other contaminants.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Our Trim Restoration service brings new life to faded and oxidized exterior plastic and rubber trim, restoring your vehicle's sleek appearance.",
    benefits: [
  ...
  const handleMaintenanceSelection = (
    ...
    setMaintenanceSelection((prev) => {
      ...
      if (prev?.packageName === packageName) {
        return prev.scope === scope ? null : { packageName, scope };
      }
      // Set new selection for different package
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            {services.slice(0, 3).map((service) => (
              ...
              >
                ...
                <div className="p-8 flex flex-col flex-grow">
                  ...
                  <button
                    className="w-full bg-[#606c38] text-white py-3 px-6 rounded-full hover:bg-[#515c30] transition-all duration-300 hover:scale-105 mt-6"
                    onClick={() => handleChoosePackage(service.name)}
                  >
                    {maintenanceSelection?.packageName === service.name
                      ? `Get ${service.name} & Maintenance`
                      : `Get ${service.name}`}
                  </button>
                </div>
              </div>
          ...
          <div className="col-span-full md:col-span-3 flex justify-center mt-8">
            <div className="bg-gradient-to-br from-[#283618] to-[#606c38] border-white/20 rounded-2xl backdrop-blur-sm w-full md:w-2/3 h-auto">
              <div className="p-6">
                <h3 className="text-2xl font-bold text-white mb-4">Custom</h3>
                <p className="text-gray-400 mb-4">
                  Build your own custom package tailored to your vehicle&apos;s
                  needs
                </p>
        ...
        <div className="mb-16">
          ...
          <p className="text-center text-[#606c38] font-semibold mb-4">
            Price varies depending on vehicle condition
          </p>
